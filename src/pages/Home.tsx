...
const Home = () => {
  return (
    ...
    >
      ...
      <div className={`bg-primaryGreen  ${styles.flexCenter}`}>
      ...
      <div className={` ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>{/* <PastConferences /> */}</div>
      </div>

      <div className={` ${styles.paddingX} ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>{/* <Partners /> */}</div>
      </div>

      <div className={` ${styles.paddingX} ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>{/* <CTA /> */}</div>
      </div>

      <div className={` ${styles.paddingX} pt-5 ${styles.flexCenter}`}>
        <div className={`${styles.boxWidth}`}>
          <p
            className={`${styles.heading2} text-primaryYello mb-4 underline text-center md:text-[33px]`}
          >
            Register
          </p>

          {/* <BecomePartner
            type={"You got a new request to join the YWGN network from"}
            text={"Please fill out the form to join Our Network"}
          /> */}
        </div>
      </div>
